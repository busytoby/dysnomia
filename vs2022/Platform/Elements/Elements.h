...
namespace Dysnomia {
	namespace Platform {
		...
		public:
			...
			static property Quark<Beryllium^, Beryllium^, Boron^>^ Uranus { Quark<Beryllium^, Beryllium^, Boron^>^ get() { return Oxygen::Uranus; }};
			...
			static property Quark<Aluminium^, Silicon^, Coronium^>^ Thalassa { Quark<Aluminium^, Silicon^, Coronium^>^ get() { return Phosphorous::Thalassa; }};
